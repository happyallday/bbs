...
public class AuditController {
    ...
    public ResponseResult<Void> approve(
        ...
        try {
            ...
            return ResponseResult.successMessage("审核通过");
        } catch (Exception e) {
            log.error("审核通过失败", e);
            return ResponseResult.errorMessage("审核通过失败: " + e.getMessage());
        }
    }
    ...
    public ResponseResult<Void> reject(
        ...
        try {
            ...
            return ResponseResult.successMessage("审核驳回");
        } catch (Exception e) {
            log.error("审核驳回失败", e);
            return ResponseResult.errorMessage("审核驳回失败: " + e.getMessage());
        }
    }
